...
namespace Microsoft.Windows.Shell
{
    ...
    internal class WindowChromeWorker : DependencyObject
    {
        ...
        private void _SetWindow(Window window)
        {
            ...
            // the NonClientFrameEdges property which requires this kind of fixup to be a bit more ubiquitous.
        ...
        private bool _MinimizeAnimation
        {
            get
            {
                return SystemParameters.MinimizeAnimation && _chromeInfo.IgnoreTaskbar == false;
            }
        }
        ...
        private IntPtr _HandleWindowPosChanging(WM uMsg, IntPtr wParam, IntPtr lParam, out bool handled)
        {
            if (!_isGlassEnabled)
            {
                ...
                if (_chromeInfo.IgnoreTaskbar && _GetHwndState() == WindowState.Maximized && wp.flags == SWP.FRAMECHANGED)
                {
                    wp.flags = 0;
        ...
        private void _SetRoundingRegion(WINDOWPOS? wp)
        {
            ...
            if (wpl.showCmd == SW.SHOWMAXIMIZED)
            {
                ...
                else
                {
                    ...
                    rcMax = _chromeInfo.IgnoreTaskbar ? mi.rcMonitor : mi.rcWork;
